    ...
    <div class="row">
        ...
        <div class="col-md-4 center-section">
            ...
            <div class="box1-2">
                ...
                <p class="p1-2">女</p>
                <label for="radio">
                        <input type="radio" class="btn1" name="gender" value=1 required="required">
                </label>
                <label for="radio">
                        <input type="radio" class="btn2" name="gender" value=0>
                </label>
            </div>
            <br>
            <div class="box1-2">
                ...
                <label for="radio">
                        <input type="radio" class="btn3" name="lenses" value=1 required="required">
                </label>
                <label for="radio">
                        <input type="radio" class="btn4" name="lenses" value=0>
                </label>
            </div>
            <br>
            <div class="box1-2">
                ...
                <label for="radio">
                        <input type="radio" class="btn3" name="hair_dying" value=1 required="required">
                </label>
                <label for="radio">
                        <input type="radio" class="btn4" name="hair_dying" value=0>
                </label>
            </div>
        </div>
